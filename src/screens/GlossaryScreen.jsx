  ...
  return (
    <>
      <div className="screen">
        ...
        <p className="lede">Fire and replace your coach, fire your GM, release a player, or invest in your fanbase. Releasing or firing never costs anything up front — it credits half of the outgoing party's cost back to your budget, starting next season: for as many seasons as a released player had left on their contract, or for exactly one season for a coach or GM. Hiring a replacement coach still costs their salary this season; firing a GM draws a random GM and market size and is limited to once per season.</p>
